 ...
 *
 * DOM Field Map:
 *   (no DOM map available â€” using autoHeal fallbacks)
 *
...
Then('the Customer Care page is displayed', async function () {
  ...
  if (_ok && _pageName) {
    ...
    if (!_urlOk) {
      // URL doesn't match â€” fall back to checking visible heading text
      ...
      if (!_ok) console.warn(`âš ï¸  Page "${_pageName}" expected â€” current URL is ${_curUrl}`);
    }
  }
...
// NOTE: Generic steps for "opens the X website", "navigates to the X menu",
// "clicks the X submenu", and "the X page should be displayed" have been
